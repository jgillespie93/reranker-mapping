...
This repository contains the Qwen 3 Reranker implementation used in **Step 4 of the automated food classification pipeline** described in *"A harmonised FoodEx2-to-FABIO dataset for country-specific, multi-indicator environmental assessment of food consumption"*.
